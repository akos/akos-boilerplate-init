...
module.exports = class Command extends baseClass {
  ...
  async run(cwd, args) {
    ...
    if (biolerplateType === 'fullstack') {
      ...
      console.log(symbols.success, chalk.blue('The blank fullstack boilerplate is finish\n'));
      console.log(symbols.info, chalk.yellow('Install client boilerplate into the fullstack'));
      console.log(symbols.success, chalk.green('Please choose your favorite client boilerplate'));
      ...
      console.log(symbols.info, chalk.yellow('Install server boilerplate into the fullstack'));
      console.log(symbols.success, chalk.green('Please choose your favorite server boilerplate'));
